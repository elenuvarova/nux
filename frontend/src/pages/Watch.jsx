...
const IconCaptions = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    ...
    <path d="M8 9.2a1.8 1.8 0 0 0-3 1.3 1.8 1.8 0 0 0 3 1.3M14.5 9.2a1.8 1.8 0 0 0-3 1.3 1.8 1.8 0 0 0 3 1.3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
const IconGear = () => (
